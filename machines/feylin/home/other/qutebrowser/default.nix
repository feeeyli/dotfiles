    ...
    settings = {
      ...
      colors = {
        tabs = {
          ...
          selected = {
            odd = {
              ...
              fg = colorscheme.primary-foreground;
            };
            even = {
              bg = colorscheme.primary;
              fg = colorscheme.primary-foreground;
          ...
          indicator = {
            error = colorscheme.yellow;
            start = colorscheme.cyan;
            stop = colorscheme.green;
          };
        };
        ...
        completion = {
          ...
          odd.bg = config.theme.programs.qutebrowser.completion.odd;
          even.bg = config.theme.programs.qutebrowser.completion.even;
          ...
          item.selected = {
            ...
            fg = foreground;
            match.fg = colorscheme.darker-gray;
          };
        };
        ...
        statusbar = {
          ...
          progress.bg = colorscheme.primary;

          url = {
            fg = foreground;
            hover.fg = colorscheme.pink;
            success.http.fg = colorscheme.primary;
            success.https.fg = colorscheme.primary;
            warn.fg = colorscheme.yellow;
            error.fg = colorscheme.orange;
          };
        };
