...
let
  ...
  punctuation_fg = colors.gray;
  neutral_fg = colors.white;
  method_fg = colors.lighter-gray;
  property_fg = colors.lighter-gray;

  type_fg = colors.orange;
  tag_fg = colors.yellow;
  value_fg = colors.green;
  function_fg = colors.cyan;
  class_fg = colors.blue;
  comment_fg = colors.pink;
  variable_fg = colors.purple;
in
{
  highlight = {
    Comment = {
